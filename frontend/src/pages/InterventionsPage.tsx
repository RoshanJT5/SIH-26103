  ...
  return (
    <section className="section" aria-labelledby="t"><div className="wrap">
      <div className="section-head">
        <p className="section-eyebrow">Predictions · Intervention Priority</p>
        <h2 id="t" style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <ListOrdered size={24} color="var(--navy-700)" /> Priority Queue
        </h2>
        <p>Transparent weighted score: {data.formula}. Version {data.version}. Drivers list per project shows contributions.</p>
      </div>
